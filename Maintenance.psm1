function Run_Maintenance {
    ...
    $user = (Get-WMIObject -ClassName Win32_ComputerSystem).PrimaryOwnerName
    ...
    $searchResult = $updateSearcher.Search("IsInstalled=0 and Type='Software' and IsHidden=0")
        ...
        CheckTPMEnabled = "if ($tpm -eq $true){continue}elseif ($tpm -eq $false){Enable-TpmAutoProvisioning #Dont think this is the right command to enable TPM}}"
